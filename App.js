...
export default class App extends Component {
  ...
  componentDidMount() {
    this.timer = setInterval(() => this.getDonorData(), 1000);
  }

  async getDonorData() {
    return fetch(`https://bloodbankapplication-8333e-default-rtdb.firebaseio.com/donors.json`)
  ...
  addDonorData = (name, mobile, group) => {
    if (this.state.name != null && this.state.mobile != null && this.state.group != null) {
      fetch('https://bloodbankapplication-8333e-default-rtdb.firebaseio.com/donors.json', {
        method: 'POST',
        headers: {
  ...
  onChange_ofValue(value) {
    this.setState({
      group: value
    });
  }

  onChange_ofValue2(value) {
    this.setState({
        ...
        <Content style={{ marginLeft: 10, marginRight: 10 }}>
          <View style={{ backgroundColor: "#f2eded", marginTop: 10 }}>
            {this.state.isSubmited
              ?
              <TouchableOpacity onPress={() => this.no_data_added()}>
              ...
              <View style={{ paddingLeft: 20, paddingRight: 20, paddingBottom: 40 }}>
                ...
                <View style={styles.picker}>
                  <Picker
                    ...
                    onChange_ofValue={this.onChange_ofValue.bind(this)}>
                ...
                <Button block light onPress={() => this.addDonorData(this.state.name, this.state.mobile, this.state.group)} style={{ marginLeft: 30, marginRight: 30 }}>
                  <Text>Submit</Text>
                </Button>
              </View>
            }
          ...
          <View>
            ...
            <View style={styles.picker}>
              <Picker
                ...
                onChange_ofValue={this.onChange_ofValue2.bind(this)}>
                <Picker.Item label="Blood Group" value="null" />
                <Picker.Item label="A+" value="A+" />
                <Picker.Item label="A-" value="A-" />
                <Picker.Item label="B+" value="B+" />
